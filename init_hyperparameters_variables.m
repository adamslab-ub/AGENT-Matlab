...
% These parameters can be chosen by user or use the default values
...
r_mute_w0=0.1;
r_mute_add_edge0=0.007;
r_mute_add_node0=0.003;
r_mute_change_node_change_type0=0.01;
r_mute_change_node_change_time0=0.01;
...
perc_elited_saves=0.05;
elite_perce_to_reproduce=1.0;
r_crosover=0.85;
r_unif=0.9;
unif_perc=0.1;
...
perc_elited_to_mute_elite=0.001;
num_enter_tor=5;
num_win_tor=2;
...
K_niche_neighborhood = 1;% definetly can be tuned
alpha_niche_neighborhood = 1;% definetly can be tuned
